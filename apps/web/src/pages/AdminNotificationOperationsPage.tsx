...
export function AdminNotificationOperationsPage() {
  ...
  return (
    <main className="page notification-operations-page">
      ...
      <header><div><span className="eyebrow">Operasyon</span><h1>Bildirim teslimatları</h1><p>E-posta ve push kanallarının son 200 teslimatını izle ve başarısız kayıtları yeniden dene.</p></div><select onChange={(event) => setStatus(event.target.value)} value={status}><option value="failed">Başarısız</option><option value="pending">Bekliyor</option><option value="sent">Gönderildi</option><option value="skipped">Atlandı</option><option value="">Tümü</option></select></header>
