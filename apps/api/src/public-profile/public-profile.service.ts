...
export class PublicProfileService {
  ...
  private async getProfile(identifier: { id: string } | { username: { equals: string; mode: "insensitive" } }, viewerId?: string, viewerRole?: string) {
    ...
    return {
      ...
      district: this.canView(privacy.locationAudience ?? "everybody", relationship) ? profile.district : null,
      address: this.canView(privacy.locationAudience ?? "everybody", relationship) ? profile.address : null,
