...
- Web etkileşim testleri: **6 suite / 34 test geçti**. Önceki akışlara ek olarak etkinlik düzenleme/program/bilet platformları, ücretsiz bilet, pending bağlantısı, uzun açıklama, program etiketi, takipçi tooltip'i, boş arama, küratör başvurusu, ortak adres seçici, mekân oluşturma ve gizlilik alanları doğrudan kullanıcı etkileşimiyle doğrulandı.
